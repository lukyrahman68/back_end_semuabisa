    ...
    <section style="padding-top:5em;">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4">
                    <img src="<?php echo e(asset('img/service/our_services.png')); ?>" alt="" style="max-height: 100%;max-width:100%">
                </div>
                <div class="col-md-4"></div>
            </div>
            <br>
            <div class="row" style="margin-bottom: 3em;">
                ...
                <div class="col-md-5">
                    <img src="<?php echo e(asset('img/service/PREWED.jpg')); ?>" alt="" style="max-height: 100%;max-width:100%">
                </div>
                <div class="col-md-7">
            ...
            <div class="row" style="margin-bottom: 3em;">
                ...
                <div class="col-md-5">
                    <img src="<?php echo e(asset('img/service/WEDDING.jpg')); ?>" alt="" style="max-height: 100%;max-width:100%">
                </div>
            </div>
            <div class="row" style="margin-bottom: 3em;">
                <div class="col-md-5">
                    <img src="<?php echo e(asset('img/service/Dokumentasi.jpg')); ?>" alt="" style="max-height: 100%;max-width:100%">
                </div>
                <div class="col-md-7">
            ...
            <div class="row" style="margin-bottom: 3em;">
                ...
                <div class="col-md-5">
                    <img src="<?php echo e(asset('img/service/Branding.jpg')); ?>" alt="" style="max-height: 100%;max-width:100%;object-fit: cover">
                </div>
            </div>
        </div>
    </section>
