<?php $__env->startSection('content'); ?>
    ...
    <section class="main_slider_area">
        <div id="main_slider" class="rev_slider" data-version="5.3.1.6">
            <ul>
                <li data-index="rs-2972" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="default"  data-thumb="<?php echo e(asset('img/home_img.jpg')); ?>"  data-rotate="0"  data-saveperformance="off"  data-title="Web Show" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                    <!-- MAIN IMAGE -->
                    <img src="<?php echo e(asset('img/wedding-murah-surabaya.jpg')); ?>"  alt="Wedding Foto Video Cinematic Surabaya" title="Wedding Foto Video Cinematic Surabaya"  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="5" class="rev-slidebg" data-no-retina>
                    <!-- LAYERS -->
                    <div class="slider_text_box">
                        ...
                        data-paddingbottom="[0,0,0,0]"
                        data-paddingleft="[0,0,0,0]"><span>SEMUABISA</span></div>
                    <!--<img src = "<?php echo e(asset('img/Selamat Datang.png')); ?>" max-width="100">-->
        ...
        <div class="container padding_vh">
            <div class="row" style="margin: 0;margin-bottom: 1em;">
                ...
                <div class="col-md-6 col-xs-12">
                    <img src="<?php echo e(asset('img/foto-wedding-surabaya.jpg')); ?>" alt="Wedding Foto Video Cinematic Surabaya" title="Wedding Foto Video Cinematic Surabaya" style="max-width: 100%;max-height: 100%">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="left_service">
            <div class="left_service_inner">
                <div class="service_item">
                    <div class="service_item_inner">
                        <div class="service_icon">
                            <img src="<?php echo e(asset('img/SB_movie.png')); ?>" height="50" width="50" alt="">
                            <img src="<?php echo e(asset('img/SB_movie_black.png')); ?>" height="50" width="50" alt="">
                        </div>
                        ...
                        <a class="view_btn" href="<?php echo e(route('services')); ?>">Read Details</a>
                    </div>
                </div>
                <div class="service_item">
                    <div class="service_item_inner">
                        <div class="service_icon">
                            <img src="<?php echo e(asset('img/SB_camera.png')); ?>" height="50" width="50" alt="">
                            <img src="<?php echo e(asset('img/SB_camera_black.png')); ?>" height="50" width="50" alt="">
                        </div>
                ...
                <div class="service_item">
                    <div class="service_item_inner">
                        <div class="service_icon">
                            <img src="<?php echo e(asset('img/SB_camera1.png')); ?>" height="50" width="50" alt="">
                            <img src="<?php echo e(asset('img/SB_camera_black1.png')); ?>" height="50" width="50" alt="">
                        </div>
                ...
                <div class="service_item">
                    <div class="service_item_inner">
                        <div class="service_icon">
                            <img src="<?php echo e(asset('img/SB_camera2.png')); ?>" height="50" width="50" alt="">
                            <img src="<?php echo e(asset('img/SB_camera_black2 .png')); ?>" height="50" width="50" alt="">
                        </div>
                ...
                <div class="col-md-3">
                    <div class="project_left_side">
                        ...
                        <ul class="our_project_filter">
                            ...
                            <?php $__currentLoopData = $projeks->unique('kategori'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $projek): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li data-filter=".<?php echo e($projek->kategori); ?>"><a href="#"><?php echo e($projek->kategori); ?>   </a></li>
                ...
                <div class="col-md-9">
                    <div class="our_project_details">
                        ...
                        <div class="project_item <?php echo e($projek->kategori); ?> isolation tiling hitam_putih">
                            <img src="<?php echo e(asset('project/wedding-surabaya/foto-video-cinematic/'.$projek->id.'-'.$projek->idmedia.'.'.$projek->format)); ?>" alt="Wedding Foto Video Cinematic Surabaya" title="Wedding Foto Video Cinematic Surabaya" width="275" height="280" style="object-fit: cover; margin-bottom:0.5em;">
                            <div class="project_hover">
                                <div class="project_hover_inner">
                                    <div class="project_hover_content">
                                        <a href="#"><h4 itemprop="nama"><?php echo e($projek->nama); ?></h4></a>
                                        <p itemprop="deskripsi"><?php echo str_limit($projek->deskripsi,50); ?> </p>
    ...
    <section class="ins-parent">
        ...
        <!--<div class="container">-->
        <!--   <img src="<?php echo e(asset('img/cara-order-wedding-foto-video-cinematic-surabaya.png')); ?>" alt="" style="max-width: 100%">-->
        <!--</div>-->
    </section><br><br>
    <!--================End Counter Area =================-->
    <!--<section>
            ...
            <div class="row testimonials_inner">
                ...
                <div class="col-md-8">
                    <div class="testimonials_slider owl-carousel">
                        <?php $__currentLoopData = $testimonis->unique('id'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $testimoni): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="item">
                            <div class="testi_left">
                                <i class="fa fa-quote-right" aria-hidden="true"></i>
                                <p itemprop="testimoni-keterangan"><?php echo e($testimoni->testimoni); ?></p>
                                <a itemprop="testimoni-nama" href="#"><h4><?php echo e($testimoni->nama); ?></h4></a>
                            </div>
                            <div class="testi_right">
                                <img src="<?php echo e(asset('testimoni/'.$testimoni->id.'.'.$testimoni->format)); ?>" alt="" class="testi_right">
                            </div>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
