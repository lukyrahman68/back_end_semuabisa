<?php $__env->startSection('content'); ?>
        ...
        <div id="main_slider" class="rev_slider" data-version="5.3.1.6">
            <ul>
                <li data-index="rs-2972" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="default"  data-thumb="<?php echo e(asset('img/home_img.jpg')); ?>"  data-rotate="0"  data-saveperformance="off"  data-title="Web Show" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                    <!-- MAIN IMAGE -->
                    <img src="<?php echo e(asset('img/home_img.jpg')); ?>"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="5" class="rev-slidebg" data-no-retina>
                    <!-- LAYERS -->
                    ...
                    <div class="tp-caption first_text"
                        ...
                        data-y="['middle','middle','middle','middle']"
                        data-hoffset="['0','0','0','0']"
                        data-voffset="['92','92','92','28','28']"
                        data-fontsize="['60','60','60','35','35']"
                        data-lineheight="['100','100','100','70','70']"
                        data-width="['none','none','none','none']"
                        data-height="none"
                        data-whitespace="['nowrap','nowrap','nowrap','nowrap','nowrap']"
        ...
        <div class="container padding_vh">
            <div class="row" style="margin: 0;margin-bottom: 1em;">
                ...
                <div class="col-md-6 col-xs-12">
                    <img src="<?php echo e(asset('img/Kolase.jpg')); ?>" alt="" style="max-width: 100%;max-height: 100%">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="ins-parent">
        ...
        <!--<div class="container">-->
        <!--   <img src="<?php echo e(asset('img/Instruksi.png')); ?>" alt="" style="max-width: 100%">-->
        <!--</div>-->
    </section><br><br>
    <!--================End Counter Area =================-->
    <!--<section>
                    ...
                    <div class="testimonials_slider owl-carousel">
                        ...
                        <div class="item">
                            <div class="testi_left">
                                ...
                                <p><?php echo e($testimoni->testimoni); ?></p>
                                <a href="#"><h4><?php echo e($testimoni->nama); ?></h4></a>
                            </div>
                            <div class="testi_right">
                                <img src="<?php echo e(asset('testimoni/'.$testimoni->id.'.'.$testimoni->format)); ?>" alt="" style="max-width:100%;max-heigh:100%">
                            </div>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
