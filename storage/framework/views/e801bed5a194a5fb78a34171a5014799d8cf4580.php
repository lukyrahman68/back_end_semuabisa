<?php $__env->startSection('content'); ?>
    ...
    <section class="main_slider_area">
        <div id="main_slider" class="rev_slider" data-version="5.3.1.6">
            <ul>
                <li data-index="rs-2973" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="default"  data-thumb="<?php echo e(asset('img/home-slider/slider-1.jpg')); ?>"  data-rotate="0"  data-saveperformance="off"  data-title="Web Show" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                    <!-- MAIN IMAGE -->
                    <img src="<?php echo e(asset('img/about/pre-wedding-pernikahan-foto-video-surabaya/Logo_bg.jpg')); ?>"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="5" class="rev-slidebg" data-no-retina>
                    <!-- LAYERS -->
                    <div class="slider_text_box2">
                        ...
                        data-voffset="['10','10','10','5','0']"
                        data-fontsize="['40','40','40','30','30']"
                        ...
                        data-paddingleft="[0,0,0,0]"><span><b>THERE IS</b> ALL </span><br>YOU WANT TO KNOW<br><b>ABOUT US</b></div>

                        <div class="tp-caption"
                        data-x="['left','left','left','left','left']"
                        data-y="['middle','middle','middle','middle']"
                        data-hoffset="['0','15','15','15','15']"
                        data-voffset="['100','100','100','90','80']"
                        ...
                        data-paddingright="[0,0,0,0]"
                        data-paddingbottom="[0,0,0,0]"
                        data-paddingleft="[0,0,0,0]"><a class="btn btn-danger btn-sm" href="<?php echo e(route('services')); ?>">Browse Services</a>&nbsp;</div>
                    </div>
                </li>
            </ul>
        </div>
...
">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4" align="center">
                        <img src="<?php echo e(asset('img/about/pre-wedding-pernikahan-foto-video-surabaya/Our Company.jpg')); ?>" alt="" srcset="" style="max-width:80%;">
                </div>
                <div class="col-md-4"></div>
            </div>
    ...
    <!--<section>
        <div class="col-md-12" style="position: relative">
            <img src="<?php echo e(asset('img/about/pre-wedding-pernikahan-foto-video-surabaya/Photo 2.jpg')); ?>"  srcset="" style="max-width:100%;height: 250px;min-width:100%;object-fit: cover">
        </div><br><br><br><br>
        <div class="row" style="position: absolute;">
                <div class="col-md-6"></div>
                <div class="col-md-3">
                    <img src="<?php echo e(asset('img/about/pre-wedding-pernikahan-foto-video-surabaya/Our Prespective.png')); ?>" alt="" srcset="" style="max-width:50%;">
                </div>
        ...
        <div class="container" >
            <div class="col-md-12">
                <div class="visimisi"></div>
                    <!--<img src="<?php echo e(asset('img/about/pre-wedding-pernikahan-foto-video-surabaya/Visi Misi.png')); ?>" alt="" srcset="" style="max-width:100%;">-->
            </div>
            <div class="col-md-12" style="background-color: #eee">
                <div class="row">
                    <div class="col-md-4"></div>
                    <div class="col-md-4" style="text-align: center">
                        <img src="<?php echo e(asset('img/about/pre-wedding-pernikahan-foto-video-surabaya/Our Team.png')); ?>" alt="" srcset="" style="max-width:100%;max-height: 100px;">
                        <p>
