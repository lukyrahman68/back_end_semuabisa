<?php $__env->startSection('content'); ?>
    ...
    <section style="padding-top:5em;background-color: #e64343">
        <div class="container">
            ...
            <div class="row">
                <form action="<?php echo e(route('mail')); ?>" method="get">
                    <?php echo csrf_field(); ?>
                ...
                <div class="col-md-6"><br><br><br>
                    <div class="row">
                        <div class="col-md-3 col-xs-3" style="padding-bottom: 5px;text-align: right">
                            <img src="<?php echo e(asset('img/gm.png')); ?>" alt="" style="max-height: 70px;max-width: 70px">
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-3 col-xs-3" style="padding-bottom: 5px;text-align: right">
                            <img src="<?php echo e(asset('img/wa.png')); ?>" alt="" style="max-height: 70px;max-width: 70px">
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-3 col-xs-3" style="padding-bottom: 5px;text-align: right">
                            <img src="<?php echo e(asset('img/gmail.png')); ?>" alt="" style="max-height: 70px;max-width: 70px">
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-3 col-xs-3" style="padding-bottom: 5px;text-align: right">
                            <img src="<?php echo e(asset('img/ig.png')); ?>" alt="" style="max-height: 70px;max-width: 70px">
                        </div>
                        <div class="col-md-9 col-xs-9" style="text-align: left;margin-top: 17px;">
