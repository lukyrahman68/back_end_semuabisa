                    ...
                    <div class="btn-group btn-group-toggle" data-toggle="buttons">
                      <label class="btn btn-primary
                        <?php if($sub_data=="pre-wedding"): ?>
                            active
                        <?php endif; ?>
                      " onclick="location.href='<?php echo e(route("pre-wedding")); ?>'" style="padding-left: 4px;padding-right: 4px;">
                      ...
                      <label class="btn btn-primary
                        <?php if($sub_data=="wedding"): ?>
                            active
                        <?php endif; ?>
                      " onclick="location.href='<?php echo e(route("wedding")); ?>'" style="padding-left: 4px;padding-right: 4px;">
                      ...
                      <label class="btn btn-primary
                        <?php if($sub_data=="dokumentasi"): ?>
                            active
                        <?php endif; ?>
                      " onclick="location.href='<?php echo e(route("dokumentasi")); ?>'" style="padding-left: 4px;padding-right: 4px;">
                      ...
                      <label class="btn btn-primary
                        <?php if($sub_data=="branding"): ?>
                            active
                        <?php endif; ?>
                      " onclick="location.href='<?php echo e(route("branding")); ?>'" style="padding-left: 4px;padding-right: 4px;">
                        <input type="radio" name="options" id="option3" autocomplete="off"
                        <?php if($sub_data=="branding"): ?>
                            checked
                        <?php endif; ?>
                                    ...
                                    <div class="col-md-9">
                                        <div class="our_project_details">
                                            ...
                                            <div class="project_item <?php echo e($projek->kategori); ?> isolation tiling hitam_putih">
                                                <img src="<?php echo e(asset('project/wedding-surabaya/foto-video-cinematic/'.$projek->id.'-'.$projek->idmedia.'.'.$projek->format)); ?>" alt="" width="275" height="280" style="object-fit: cover; margin-bottom:0.5em;">
                    ...
                    <div class="testimonials_slider owl-carousel">
                        ...
                        <div class="item">
                            ...
                            <div class="testi_right">
                                <img src="<?php echo e(asset('testimoni/'.$testimoni->id.'.'.$testimoni->format)); ?>" alt="" style="max-width:160px;max-height:240px">
                            </div>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
