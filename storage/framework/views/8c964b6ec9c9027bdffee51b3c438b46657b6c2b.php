                ...
                <div class="main_c_title">
                    ...
                    <div class="btn-group btn-group-toggle " data-toggle="buttons" style="max-width:400px;">
                            ...
                            <?php if($sub_data=="pre-wedding"): ?>
                                active
                            <?php endif; ?>
                          " onclick="location.href='<?php echo e(route("pl_pre-wedding")); ?>'">
                          ...
                          <label class="btn btn-primary
                            <?php if($sub_data=="wedding"): ?>
                                active
                            <?php endif; ?>
                          " onclick="location.href='<?php echo e(route("pl_wedding")); ?>'">
                          ...
                          <label class="btn btn-primary
                            <?php if($sub_data=="dokumentasi"): ?>
                                active
                            <?php endif; ?>
                          " onclick="location.href='<?php echo e(route("pl_dokumentasi")); ?>'">
                          ...
                          <label class="btn btn-primary
                            <?php if($sub_data=="branding"): ?>
                                active
                            <?php endif; ?>
                          " onclick="location.href='<?php echo e(route("pl_branding")); ?>'">
                            <input type="radio" name="options" id="option3" autocomplete="off"
                            <?php if($sub_data=="branding"): ?>
                                checked
                            <?php endif; ?>
